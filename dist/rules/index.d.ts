...
export declare function getAllRules(): RuleCheck[];
export { textAlternativeRules, languageRules, structureRules, formRules, ariaRules, navigationRules, mediaRules, tableRules, landmarkRules, colorContrastRules, };
