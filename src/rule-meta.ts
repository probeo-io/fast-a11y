...
export const RULE_META: Record<string, RuleMeta> = {
  ...
  "server-side-image-map": meta("server-side-image-map", "minor",
  ...
  "select-name": meta("select-name", "critical",
    ["cat.forms", "wcag2a", "wcag412", "wcag131", "section508", "section508.22.n", "ACT"],
    "Select element must have an accessible name",
    "Ensures select element has an accessible name"),

  "input-button-name": meta("input-button-name", "critical",
  ...
  "form-field-multiple-labels": meta("form-field-multiple-labels", "moderate",
    ["cat.forms", "wcag2a", "wcag412"],
    "Form field should not have multiple label elements",
    "Ensures form field does not have multiple label elements"),

  "autocomplete-valid": meta("autocomplete-valid", "serious",
  ...
  // ARIA
  "aria-allowed-attr": meta("aria-allowed-attr", "critical",
    ["cat.aria", "wcag2a", "wcag412"],
    "Elements must only use allowed ARIA attributes",
    "Ensures ARIA attributes are allowed for an element's role"),

  "aria-allowed-role": meta("aria-allowed-role", "minor",
    ["cat.aria", "best-practice"],
    "ARIA role should be appropriate for the element",
    "Ensures role attribute has an appropriate value for the element"),

  "aria-hidden-body": meta("aria-hidden-body", "critical",
    ["cat.aria", "wcag2a", "wcag412"],
    "aria-hidden=\"true\" must not be present on the document body",
    "Ensures aria-hidden=\"true\" is not present on the document body"),

  "aria-hidden-focus": meta("aria-hidden-focus", "serious",
    ["cat.name-role-value", "wcag2a", "wcag412", "wcag131"],
    "ARIA hidden element must not be focusable or contain focusable elements",
    "Ensures aria-hidden elements are not focusable nor contain focusable elements"),

  "aria-required-attr": meta("aria-required-attr", "critical",
    ["cat.aria", "wcag2a", "wcag412"],
    "Required ARIA attributes must be provided",
    "Ensures elements with ARIA roles have all required ARIA attributes"),

  "aria-required-children": meta("aria-required-children", "critical",
    ["cat.aria", "wcag2a", "wcag131"],
    "Certain ARIA roles must contain particular children",
    "Ensures elements with an ARIA role that require child roles contain them"),

  "aria-required-parent": meta("aria-required-parent", "critical",
    ["cat.aria", "wcag2a", "wcag131"],
    "Certain ARIA roles must be contained by particular parents",
    "Ensures elements with an ARIA role that require parent roles are contained by them"),

  "aria-roles": meta("aria-roles", "critical",
    ["cat.aria", "wcag2a", "wcag412"],
    "ARIA roles used must conform to valid values",
    "Ensures all elements with a role attribute use a valid value"),

  "aria-valid-attr": meta("aria-valid-attr", "critical",
    ["cat.aria", "wcag2a", "wcag412"],
    "ARIA attributes must conform to valid names",
    "Ensures attributes that begin with aria- are valid ARIA attributes"),

  "aria-valid-attr-value": meta("aria-valid-attr-value", "critical",
    ["cat.aria", "wcag2a", "wcag412"],
    "ARIA attributes must conform to valid values",
    "Ensures all ARIA attributes have valid values"),

  "aria-roledescription": meta("aria-roledescription", "serious",
    ["cat.aria", "wcag2a", "wcag412"],
  ...
  "meta-refresh-no-exceptions": meta("meta-refresh-no-exceptions", "minor",
    ["cat.time-and-media", "best-practice"],
    "Timed refresh must not exist",
    "Ensures <meta http-equiv=\"refresh\"> is not used"),

  "no-autoplay-audio": meta("no-autoplay-audio", "moderate",
  ...
  "th-has-data-cells": meta("th-has-data-cells", "serious",
    ["cat.tables", "wcag2a", "wcag131"],
  ...
  "td-has-header": meta("td-has-header", "serious",
    ["cat.tables", "wcag2a", "wcag131"],
  ...
  "table-duplicate-name": meta("table-duplicate-name", "minor",
  ...
  "table-fake-caption": meta("table-fake-caption", "serious",
    ["cat.tables", "best-practice"],
  ...
  "scope-attr-valid": meta("scope-attr-valid", "moderate",
    ["cat.tables", "best-practice"],
    "scope attribute should be used correctly",
    "Ensures the scope attribute is used correctly on tables"),

  // Landmarks
  "landmark-one-main": meta("landmark-one-main", "moderate",
    ["cat.semantics", "best-practice"],
    "Document should have one main landmark",
    "Ensures the document has a main landmark"),

  "landmark-no-duplicate-main": meta("landmark-no-duplicate-main", "moderate",
    ["cat.semantics", "best-practice"],
    "Document should not have more than one main landmark",
    "Ensures the document has at most one main landmark"),

  "landmark-no-duplicate-banner": meta("landmark-no-duplicate-banner", "moderate",
    ["cat.semantics", "best-practice"],
    "Document should not have more than one banner landmark",
    "Ensures the document has at most one banner landmark"),

  "landmark-no-duplicate-contentinfo": meta("landmark-no-duplicate-contentinfo", "moderate",
    ["cat.semantics", "best-practice"],
    "Document should not have more than one contentinfo landmark",
    "Ensures the document has at most one contentinfo landmark"),

  "landmark-banner-is-top-level": meta("landmark-banner-is-top-level", "moderate",
    ["cat.semantics", "best-practice"],
    "Banner landmark should not be contained in another landmark",
    "Ensures the banner landmark is at top level"),

  "landmark-contentinfo-is-top-level": meta("landmark-contentinfo-is-top-level", "moderate",
    ["cat.semantics", "best-practice"],
    "Contentinfo landmark should not be contained in another landmark",
    "Ensures the contentinfo landmark is at top level"),

  "landmark-complementary-is-top-level": meta("landmark-complementary-is-top-level", "moderate",
    ["cat.semantics", "best-practice"],
    "Aside should not be contained in another landmark",
    "Ensures the complementary landmark or aside is at top level"),

  "landmark-main-is-top-level": meta("landmark-main-is-top-level", "moderate",
    ["cat.semantics", "best-practice"],
    "Main landmark should not be contained in another landmark",
    "Ensures the main landmark is at top level"),

  "page-has-heading-one": meta("page-has-heading-one", "moderate",
    ["cat.semantics", "best-practice"],
    "Page should contain a level-one heading",
    "Ensure that the page, or at least one of its frames contains a level-one heading"),

  "landmark-unique": meta("landmark-unique", "moderate",
    ["cat.semantics", "best-practice"],
    "Ensures landmarks are unique",
    "Landmarks should have a unique role or role/label/title (i.e. accessible name) combination"),

  "region": meta("region", "moderate",
    ["cat.keyboard", "best-practice"],
    "All page content should be contained by landmarks",
    "Ensures all page content is contained by landmarks"),

  // Bypass
  "bypass": meta("bypass", "serious",
    ["cat.keyboard", "wcag2a", "wcag241", "section508", "section508.22.o"],
    "Page must have means to bypass repeated blocks",
    "Ensures each page has at least one mechanism for a user to bypass navigation and jump straight to the content"),

  // Color contrast (best-effort static)
  "color-contrast": meta("color-contrast", "serious",
    ["cat.color", "wcag2aa", "wcag143", "ACT"],
    "Elements must meet minimum color contrast ratio thresholds",
    "Ensures the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds"),

  // Presentation role
  "presentation-role-conflict": meta("presentation-role-conflict", "minor",
    ["cat.aria", "best-practice"],
  ...
  // Deprecated elements
  "label-title-only": meta("label-title-only", "serious",
